        ...
        <div class="profile-section">
            ...
            if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                ...
                if ($success) {
                    ...
                    echo '<div class="alert alert-error">There was an error updating your profile. Please try again.</div>';
                }
            }
            ...
            $profile_data = [
                ...
                'email' => 'hajimi@gmail.com',
                'phone' => '+60107856788',
                'address' => '123, Taman Mambo, 11900 Bayan Lepas, Pulau Pinang',
                'emergency_contact_name' => 'Jacky',
                'emergency_contact_phone' => '+601008566543',
                'blood_type' => 'AB+',
            ...
            <form method="POST" action="edit_profile.php">
                <div class="form-group">
                    ...
                    <input type="text" id="patient_id" name="patient_id" value="<?php echo htmlspecialchars($profile_data['patient_id']); ?>" class="readonly-field" readonly>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" id="date_of_birth" name="date_of_birth" value="<?php echo htmlspecialchars($profile_data['date_of_birth']); ?>" required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="tel" id="phone" name="phone" value="<?php echo htmlspecialchars($profile_data['phone']); ?>" required>
                    </div>
                </div>
                
                <div class="form-group">
                    <label for="address">Address <span class="required">*</span></label>
                    <textarea id="address" name="address" required><?php echo htmlspecialchars($profile_data['address']); ?></textarea>
                </div>
                
                <div class="form-row">
                    <div class="form-group">
                        <label for="emergency_contact_name">Emergency Contact Name <span class="required">*</span></label>
                        <input type="text" id="emergency_contact_name" name="emergency_contact_name" value="<?php echo htmlspecialchars($profile_data['emergency_contact_name']); ?>" required>
                    </div>
                    
                    <div class="form-group">
                        <label for="emergency_contact_phone">Emergency Contact Phone <span class="required">*</span></label>
                        <input type="tel" id="emergency_contact_phone" name="emergency_contact_phone" value="<?php echo htmlspecialchars($profile_data['emergency_contact_phone']); ?>" required>
                    </div>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="primary_physician" name="primary_physician" value="<?php echo htmlspecialchars($profile_data['primary_physician']); ?>">
                    </div>
                </div>
