...
if (!$patient) {
    header('Location: staff_patient_list.php');
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_record'])) {
    ...
    // Get first available doctor for the medical record
    $doctorStmt = $pdo->query("SELECT doctor_id FROM doctor LIMIT 1");
    $doctor = $doctorStmt->fetch(PDO::FETCH_ASSOC);
    $doctor_id = $doctor ? $doctor['doctor_id'] : 1;
...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['book_appointment'])) {
    ...
    $stmt->execute([$patient_id, $doctor_id, $preferred_date, $preferred_time, $reason]);
...
<body>
    ...
    <main>
        ...
        <a href="staff_patient_list.php" class="back-link">← Back to Patient List</a>
        ...
        <section class="section-container">
            ...
            <div class="patient-info">
                ...
                <div>
                    ...
                    <div class="info-item"><strong>Registered Since:</strong> <?php echo date('M j, Y', strtotime($patient['created_at'] ?? 'now')); ?></div>
                </div>
            </div>
        </section>
        ...
        <div class="tabs">
            <button class="tab active" onclick="openTab('medical')">Medical History</button>
            <button class="tab" onclick="openTab('appointments')">Appointments</button>
            <button class="tab" onclick="openTab('add-record')">Add Medical Record</button>
            <button class="tab" onclick="openTab('book-appointment')">Book Appointment</button>
        </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            <?php foreach ($appointment_history as $appointment): ?>
                                <tr>
                                    <td><?php echo $appointment['preferred_date']; ?></td>
                        ...
                        <div class="form-group">
                            ...
                            <select id="doctor_id" name="doctor_id" required>
                                ...
                                <?php foreach ($doctors as $doctor): ?>
                                    <option value="<?php echo $doctor['doctor_id']; ?>"><?php echo htmlspecialchars($doctor['full_name']); ?> - <?php echo htmlspecialchars($doctor['specialization'] ?? 'General'); ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="form-group">
    ...
    <script>
        function openTab(tabName) {
            ...
            // Show the specific tab content and set the tab as active
